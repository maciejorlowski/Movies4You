package com.maciej.movies4you.pages.appActivity.movieDetails.tabLayout
...
class MovieDetailsTabLayout(context: Context?, attrs: AttributeSet?) : TabLayout(context, attrs) {
